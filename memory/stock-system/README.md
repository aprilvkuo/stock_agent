...
| Agent | 角色 | 版本 | 职责 | 归属人 |
|-------|------|------|------|--------|
| 基本面 Agent | 分析师 | v1.0 | 财报、估值、财务健康度分析 | 基本面 Agent |
| 技术面 Agent | 分析师 | v1.0 | K 线、均线、技术指标分析 | 技术面 Agent |
| 情绪 Agent | 分析师 | v1.0 | 新闻舆情、市场热度分析 | 情绪 Agent |
| 主 Agent | 协调者 | v1.0 | 任务分发、结果汇总、最终决策 | 协调 Agent |
| 复盘 Agent | 评估者 | v1.0 | 验证预测、评估表现、更新规则 | 协调 Agent |
